...
<header class="flexColumn"> 
    ...
    <div class="headerContainer"> 
        ...
        <div class="signInUp">
            ...
            <div class="dropdown4">
                <button class="dropbtn4"><a href="index.php?action=profile&user=<?=$_SESSION['uid'];?>"><img src="<?= (isset($_SESSION['profile_img'])) ? './profile_images/'.$_SESSION['profile_img'] : "./public/images/defaultProfile.jpg" ?>" alt="defaultPic"></a></button>
