...
<header class="flexColumn"> 
    ...
    <div class="headerContainer"> 
        ...
        <div class="signInUp">
            ...
            <div class="dropdown4">
                <button class="dropbtn4"><a href=""><img src="./profile_images/<?= (isset($data['profile_img'])) ? './profile_images/'.$data['profile_img'] : "./public/images/defaultProfile.jpg" ?>" alt="defaultPic"></a></button>
